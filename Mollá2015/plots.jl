...
begin
	data = CSV.read(
		...
		DataFrame; 
		header = [
			"R", "ΣHI", "ΣHI error", "ΣHII", "ΣHII error", "logΣ*", 
...
let
	...
	ax2 = Axis(
		f[1,2], 
		xlabel = L"\mathrm{R \, / \, kpc}", 
		ylabel = L"\Sigma_\mathrm{HII} \, / \, \mathrm{M_\odot \, pc^{-2}}", 
		xlabelsize = 18,
		ylabelsize = 18,
		xticklabelsize = 20,
		yticklabelsize = 20,
	...
	errorbars!(
		ax2, 
		data[!, "R"], data[!, "ΣHII"], data[!, "ΣHII error"], 
		color = :red,
    	whiskerwidth = 10,
	)
	scatter!(ax2, data[!, "R"], data[!, "ΣHII"], markersize = 6, color = :red)
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "06252e210ca7aa3432f300795d76862c629f09cc"
