...
let
	...
	lines!(
		ax, 
		0.5..2.5, x -> fit_func(x, log10(1 + 0.5)), 
		color = :blue, 
		linewidth = 4,
		label = "0.3 < z < 0.7",
	)
	lines!(
		ax, 
		0.5..2.5, x -> fit_func(x, log10(1 + 0.95)), 
		color = :red, 
		linewidth = 4,
		label = "0.7 < z < 1.2",
	)
	lines!(
		ax, 
		0.5..2.5, x -> fit_func(x, log10(1 + 1.5)), 
		color = :green, 
		linewidth = 4,
		label = "1.2 < z < 1.8",
	)
	lines!(
		ax, 
		0.5..2.5, x -> fit_func(x, log10(1 + 2.15)), 
		color = :orange, 
		linewidth = 4,
		label = "1.8 < z < 2.5",
	)
	lines!(
		ax, 
		0.5..2.5, x -> fit_func(x, log10(1 + 3)), 
		color = :purple, 
		linewidth = 4,
		label = "2.5 < z < 3.5",
	)
	lines!(
		ax, 
		0.5..2.5, x -> fit_func(x, log10(1 + 4.25)), 
		color = :black, 
		linewidth = 4,
		label = "3.5 < z < 5",
	)
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "3a365e13247c47655d991ae8846fa77f6efaf7d3"
