...
using CairoMakie, LaTeXStrings, FITSIO, Measurements
...
begin
	...
	logMH     = read(data, "logMH")
	logMH_err = read(data, "logMH_err")
	MH        = exp10.(logMH .± logMH_err)
end;
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "d0c6ffb6a526ee50e08f59dd603f14c5cc6b8c3a"
