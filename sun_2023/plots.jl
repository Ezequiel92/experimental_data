...
raw_data = readdlm("./data/apjlacbd9ct3_mrt.txt", skipstart=57, header=false);
...
let
	...
	for galaxy_idx in 1:80
		...
		data = clean_data[clean_data.x1 .== galaxies[galaxy_idx], :]
...
let
	...
	for galaxy in gals_range 
		...
		data = clean_data[clean_data.x1 .== galaxy, :]
