...
using DelimitedFiles, CairoMakie, LaTeXStrings, FITSIO, Statistics
...
# ╔═╡ 10404b4c-cea0-4192-bfb7-b13b7c5c093c
data
...
# ╔═╡ a4472341-37b6-4ecb-a46a-d6f7c0885662
begin
	R90_kpc = filter(
		x -> (!isnan(x) && x > 0.0),
		read(data, "R50KPC") .* read(data, "CINDX"),
	)
	println("Radius:\n")
	println("\tMean: $(mean(R90_kpc)) kpc")
	println("\tMin, Max: $(extrema(R90_kpc)) kpc")
	println("\tStandard deviation: $(std(R90_kpc)) kpc\n")
	println("Redshift:\n")
	println("\tMin, Max: $(extrema(redshift))")
end
...
manifest_format = "2.0"
project_hash = "bcf89e239829339b30dd63945922d26453d59b17"
