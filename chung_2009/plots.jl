...
# ╔═╡ 557fb100-a3f9-11ee-1c04-590af148d7ea
using CairoMakie, LaTeXStrings, DelimitedFiles, Measurements

# ╔═╡ 904cb045-a375-4039-8d27-7b987ff4289a
...
# ╔═╡ 2bfefd25-f3bd-4c53-ab94-a0d4b766f0bc
md"""
...
begin
	...
	galaxy_names_g1 = map(s -> split(s, "^")[1], raw_data_g1[:, 1])
	galaxy_names_g2 = map(s -> split(s, "^")[1], raw_data_g2[:, 1])
	
	mass_g1 = parse_measurement(raw_mass_g1)
	mass_g2 = parse_measurement(raw_mass_g2)
end;

# ╔═╡ 43d9f0bd-634d-4402-9134-8ba6bea43df4
let
...
# ╔═╡ 86e50de1-8353-4f67-b514-144b2459defd
let
	set_theme!(theme_black())
