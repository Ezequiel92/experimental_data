...
let
    ...
    axislegend(ax, position=:rb, merge=true, labelsize=25)
...
md"""
## Evolution in the specific star formation rate:

``\mathrm{sSFR} = \dfrac{\mathrm{SFR}}{M_\star} = a \, (1 + z)^b``
"""
...
let
    ...
    axislegend(ax, position=:lt, merge=true, labelsize=20)
...
manifest_format = "2.0"
project_hash = "2b910f5bc29115b45a0a0505f34d015f6cbd7cde"
