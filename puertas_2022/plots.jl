...
using CairoMakie, DelimitedFiles, LaTeXStrings, Measurements
...
# ╔═╡ 139507d1-2a3f-4503-ad69-a59e8e66854b
let
	set_theme!(theme_black())
	...
	ax = Axis(
		f[1,1],
		xlabel=L"\log_{10}(\mathrm{SFR \, / \, M_\odot \, yr^{-1}})",
		ylabel=L"12 + \log_{10}(\mathrm{O \, / \, H})",
		title=L"\mathrm{Metallicity \,\, vs. \,\, SFR}",
		titlesize=30,
		xlabelsize=28,
		ylabelsize=28,
		xticklabelsize=20,
		yticklabelsize=20,
		limits=(-2.1, 2.1, 8.0, 8.75),
	)
...
# ╔═╡ de020c27-7131-4429-892c-7c40afc8983c
let
	set_theme!(theme_black())
	...
	ax = Axis(
		f[1,1],
		xlabel=L"\log_{10}(\mathrm{SFR \, / \, M_\odot \, yr^{-1}})",
		ylabel=L"\log_{10}(\mathrm{N \, / \, O})",
		title=L"\mathrm{Nitrogen \,\, abundance \,\, vs. \,\, SFR}",
		titlesize=30,
		xlabelsize=28,
		ylabelsize=28,
		xticklabelsize=20,
		yticklabelsize=20,
		limits=(-2.1, 2.1, -1.6, -0.55),
	)
...
manifest_format = "2.0"
project_hash = "e0ae8b3acdc5272a2b45b26abdd04a94078781c4"
